...
public class Main2Activity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.form_fragment) {
            fragment = new FormFragment();
            selectedFragment = true;

        } else if (id == R.id.form_sumary) {
            fragment = new FormSummaryFragment();
            selectedFragment = true;

        } else if (id == R.id.form_view) {
        ...
        if (selectedFragment){
            getSupportFragmentManager().beginTransaction().replace(R.id.containerBlock, fragment).commit();
        }
